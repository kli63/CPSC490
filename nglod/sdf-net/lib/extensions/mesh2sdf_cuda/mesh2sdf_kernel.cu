...
__global__ void kernel_mesh2sdf __launch_bounds__(1024) (
...
__global__ void kernel_mesh2sdf_quad __launch_bounds__(1024) (
    const int num_points, 
    const float* __restrict__ points,
    const int num_triangles, 
    const float* __restrict__ mesh,
...
__global__ void kernel_quad_aggr __launch_bounds__(1024) (
    const int num_points, 
    const int num_triangles, 
...
__global__ void kernel_triangle2sdf_forward __launch_bounds__(1024) (
    const int num_points, 
    const float* __restrict__ points,
    const int num_triangles, 
...
__global__ void kernel_trimmesh __launch_bounds__(1024) (
    const int num_triangles, 
    const float* __restrict__ mesh,
