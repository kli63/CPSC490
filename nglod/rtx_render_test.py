...
# Add sdf-net directory to path
script_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, os.path.join(script_dir, 'sdf-net'))
...
def test_all_models():
    ...
    # Find all models
    models_dir = os.path.join(script_dir, 'sdf-net', '_results', 'models')
    ...
    # Output directory
    output_dir = os.path.join(script_dir, 'sdf-net', '_results', 'rtx_render_test')
    os.makedirs(output_dir, exist_ok=True)
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='sdf-net/_results/rtx_render_test',
